"""
DeepLearning.ai code that powers the Jupyter notebook.
This module provides utility functions for reading CSV files,
interacting with OpenAI's API, and uploading text files in a
